...
import com.projects.bryan_g8.tipcalc.TipCalcApp;
import com.projects.bryan_g8.tipcalc.fragments.TipHistoryListFragment;
import com.projects.bryan_g8.tipcalc.fragments.TipHistoryListFragmentListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final static int DEFAULT_TIP_PERCETAGE = 10;
    ...
    public int getTipPercentage() {
        int tipPercentage = DEFAULT_TIP_PERCETAGE;
        String strInputTipPercentage = inputPercentage.getText().toString().trim();
        if (!strInputTipPercentage.isEmpty()) {
            tipPercentage = Integer.parseInt(strInputTipPercentage);
        }
        else{
            inputPercentage.setText(String.valueOf(DEFAULT_TIP_PERCETAGE));
        }
